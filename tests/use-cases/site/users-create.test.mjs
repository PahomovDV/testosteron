...
tester.setupTestsWithTransactions(
    `${dirname}/../../fixtures/use-cases/site/users-create/positive`,
    'site/users-create/positive',
...
tester.setupTestsWithTransactions(
    `${dirname}/../../fixtures/use-cases/site/users-create/negative`,
    'site/users-create/negative',
