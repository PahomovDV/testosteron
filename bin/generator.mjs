...
import SiteAPIGenerator    from './generator/SiteAPIGenerator.mjs';
...
async function main(opts) {
    ...
    // const siteAPI = new SiteAPIGenerator({ model, config, logger });
    ...
    // await siteAPI.generate(options, layers);
